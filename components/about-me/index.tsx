      ...
      <div className="w-full text-center lg:text-start lg:w-1/2">
        ...
        <div className="mb-8">
          ...
          <p className="mb-2">
            ...
            completion of over 6 real-world ventures, I have honed my skills in
            both frontend and backend development, earning the stripes of a
            versatile <span className="underline italic">full-stack</span>{" "}
            developer.
          </p>

          <p className="mb-2">
            Driven by an insatiable curiosity, I navigate the ever-evolving tech
            landscape with enthusiasm, constantly seeking innovative solutions
            and embracing the{" "}
