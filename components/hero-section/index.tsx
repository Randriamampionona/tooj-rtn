      ...
      <div className="text-center w-full max-w-full md:max-w-2xl mt-24">
        ...
        <p>
          ...
          <Hint label="RANDRIAMAMPIONONA Tojonirina">
            <span className="text-sky-600 font-bold cursor-default">Tooj</span>
          </Hint>{" "}
          here, a passionate <u>full-stack web developer</u> with a laser focus
          on harnessing the power of Next.js. My journey revolves around
          ...
          Utilizing Next.js, I weave together lightning-fast, SEO-friendly, and
          scalable solutions that elevate user experiences to unparalleled
          heights.
        </p>
      </div>
